...
void setup() {
	...
	OSC_init();
//Serial.println("PIN_ENABLE_MOTORS will be LOW");
	digitalWrite(PIN_ENABLE_MOTORS, LOW);
//Serial.println("PIN_ENABLE_MOTORS set LOW");
	...
	ledcWrite(6, SERVO_AUX_NEUTRO);
//Serial.println("PIN_ENABLE_MOTORS will be HIGH");
	digitalWrite(PIN_ENABLE_MOTORS, HIGH);
// Serial.println("PIN_ENABLE_MOTORS set HIGH");
}
